...
import {formatDay, formatTime, humanizeDuration, capitalize} from '../utils/point.js';
...
function createSelectedOffersTemplate(offers) {
  ...
  <ul class="event__selected-offers">
    ${offers.map((offer) => createSelectedOfferTemplate(offer)).join('')}
  </ul>`;
}
...
function createPointTemplate(point, destination, offers) {
  ...
  return `<li class="trip-events__item">
    <div class="event">
      <time class="event__date" datetime="${dateFrom}">${formatDay(dateFrom)}</time>
